...
const navLinkClass =
  "text-sm uppercase tracking-wide text-foreground hover:text-muted-foreground transition-colors";
      ...
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/laugh" className="flex items-center gap-2">
            <span className="text-lg font-semibold uppercase tracking-wide bg-gradient-to-r from-yellow-100 to-teal-100 bg-clip-text text-transparent">
              laugh
            </span>
          </Link>
          <span className="hidden md:block text-border">|</span>
          <Link href="/" className={`hidden md:block ${navLinkClass}`}>
            Avison
          </Link>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-border bg-background">
          <div className="px-6 py-4 flex flex-col gap-4">
            ...
            <Button size="sm" variant="outline" className="w-fit uppercase tracking-wide">
              Download
            </Button>
          </div>
        </div>
