...
const mobileNavLinkClass =
  "rounded-lg px-2 py-3 text-base font-medium text-foreground transition-colors hover:bg-muted/50 hover:text-muted-foreground";
      ...
      <div className="relative z-10 mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
        <div className="flex items-center gap-6">
          <Link href="/smile" className="flex items-center gap-2">
            <span className="bg-linear-to-r from-rose-400 to-yellow-400 bg-clip-text text-lg font-semibold text-transparent">
              Smile
            </span>
          </Link>
          ...
          >
            <div className="flex flex-col gap-1">
              ...
              <SmileDownloadButton
                ...
                fileName={fileName}
                size="default"
                className="mt-2 w-fit bg-foreground text-background hover:bg-foreground/90"
              >
                Download
              </SmileDownloadButton>
            </div>
