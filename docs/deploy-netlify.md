...
|----------|---------|------|
| `SMILE_SUPPORT_EMAIL` | `support@advision.com` | Override default `support@tunedsphere.com` |
| `SMILE_DOWNLOAD_URL` | `https://advision.com/Smile-0.25.0.dmg` | External CDN or stable alias URL |
...
```
public/Smile-0.25.0.dmg  →  https://advision.com/Smile-0.25.0.dmg
```
...
1. Add custom domain in Netlify (`advision.com`, `www` if used)
...
- `https://advision.com/Smile-0.25.0.dmg` downloads the file
